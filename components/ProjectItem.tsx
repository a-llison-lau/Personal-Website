  ...
  return (
    <div className="mb-8 w-full">
      ...
      >
        ...
        <div className="flex-1 bg-gray-50 dark:bg-gray-800 p-6 rounded-b-lg">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-3 mb-4 text-sm line-clamp-3">
            {project.description}
          </p>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mt-1.5 mr-2">
                  {project.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="px-2 py-0.5 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-full text-xs hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
